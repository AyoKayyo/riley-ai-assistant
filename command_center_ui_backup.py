...
class CommandCenter(QMainWindow):
    ...
    def create_chat_area(self):
        """Chat area"""
        chat_frame = QFrame()
        chat_frame.setStyleSheet("background-color: #343541;")
        ...
        input_container.setStyleSheet("background-color: #343541; border-top: 1px solid #444654;")
        ...
        input_field_container.setStyleSheet("background-color: #40414f; border-radius: 12px;")
    ...
    def add_message(self, sender, message):
        ...
        if sender == "You":
            cursor.insertHtml(f'''
                <div style="background-color: #343541; padding: 20px 0;">
                    <div style="max-width: 800px; margin: 0 auto; padding: 0 20px;">
                        <div style="color: #ffffff; font-weight: 600; margin-bottom: 8px;">You</div>
                        <div style="color: #ececf1; line-height: 1.6;">{clean_msg}</div>
                    </div>
                </div>
            ''')
        elif sender == "System":
            ...
            cursor.insertHtml(f'''
                <div style="background-color: #444654; padding: 20px 0;">
                    <div style="max-width: 800px; margin: 0 auto; padding: 0 20px;">
